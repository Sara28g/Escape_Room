...
var save_path = "user://final_puzzle_save.dat"
...
func save_puzzle_state():
	...
	if file:
		...
		print("Final puzzle state saved")
	else:
		print("Error saving final puzzle state")
...
func load_puzzle_state():
	if FileAccess.file_exists(save_path):
		...
		if file:
			...
			print("Final puzzle state loaded, solved: ", puzzle_solved)
		else:
			print("Error loading final puzzle state")
	else:
		print("No saved final puzzle state found")
